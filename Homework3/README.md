...
Unity: Throughtout my webpage, I have maintained a unity in terms of all design elements like fonts, colors etc.

Use of Lines: I have highlighted the featured item by underlining it to make sure that the user sees it and another reason to do it is that so I could create a proper distinction.

Font: I have made sure that everything in webpage is clear and big enough, I have also imported a font from google-fonts to make the webpage prettier. 

Focal Point: I have added a badger mart icon which directs the user attention to it, this not only makes the webpage pretty but can be useful to get the attention of the user 
...
![My Visual Design](_figures/visual_design_step7.png)
